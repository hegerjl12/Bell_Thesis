...
if len(st.session_state.images_left) > 0:
     ...
     with st.form(key='wordForm'+str(st.session_state.i)):
          text1 = st.text_input(value='', key=st.session_state.i+10)
          text2 = st.text_input(value='', key=st.session_state.i+20)
          text3 = st.text_input(value='', key=st.session_state.i+30)
